...
if (not isOctave) && verLessThan('matlab',minimalMATLABVersion)  %#ok<*VERLESSMATLAB>
  msg = sprintf([...
    '\n\n'...
    '=========================================================================\n'...
...
else if isOctave && verLessThan('octave',minimalOctaveVersion)  %#ok<*VERLESSMATLAB>
  msg = sprintf([...
    '\n\n'...
    '=========================================================================\n'...
    'Easyspin: Octave version not supported\n'...
    '-------------------------------------------------------------------------\n'...
    'This version of EasySpin requires Octave %s and later.\n'...
